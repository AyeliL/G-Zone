...
<div id="company" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        ...
        <div class="alert alert-info">
            ...
            <strong>Login </strong>&nbsp;Please Enter the Company Details Below.
        </div>
