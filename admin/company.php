...
<body>
    ...
    <li  class="active">Pending Requests<span class="divider">/</span></li>
    <li><a href="company_active.php">Activated</a><span class="divider">/</span></li>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysql_query("select * from company where status='Pending'") or die(mysql_error());
                                    ...
                                    <td width="150">
                                        <a rel="tooltip"  title="Delete" id="d<?php echo $teacher_id; ?>" href="#course_id<?php echo $teacher_id; ?>" role="button"  data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;</a>
                                        <a rel="tooltip"  title="Verify" id="e<?php echo $teacher_id; ?>" href="update_status.php<?php echo '?id='.$teacher_id; ?>" class="btn btn-info"><i class="icon-check icon-large"></i>&nbsp;</a>
